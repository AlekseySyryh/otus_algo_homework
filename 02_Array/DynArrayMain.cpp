...
int main() {
    ...
    std::cout << "SingleArray" << std::endl;
    if (checkValid(singleArray)) {
        checkPerformance(singleArray,100000);
    }
    VectorArray<int> vectorArray;
    std::cout << "VectorArray 10" << std::endl;
    if (checkValid(vectorArray)) {
        checkPerformance(vectorArray,100000);
    }
    VectorArray<int> vectorArray2(1000);
    std::cout << "VectorArray 1000" << std::endl;
    if (checkValid(vectorArray2)) {
        checkPerformance(vectorArray2,100000);
    }
    return 0;
}